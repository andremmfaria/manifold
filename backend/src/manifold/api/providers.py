...
from manifold.schemas.providers import ProviderCallbackResponse, ProviderTypeResponse

router = APIRouter()


@router.get("", operation_id="listProviders", response_model=list[ProviderTypeResponse])
...
async def provider_callback(
    ...
    async def _callback() -> ProviderCallbackResponse:
