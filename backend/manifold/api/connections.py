...
from manifold.schemas.connections import ConnectionCreateRequest, ConnectionUpdateRequest
...
@router.get("/{connection_id}/auth-url")
async def get_connection_auth_url(
    ...
    async def _auth_url() -> dict[str, str | None]:
