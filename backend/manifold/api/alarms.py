...
from manifold.schemas.alarms import AlarmCreateRequest, AlarmUpdateRequest, MuteRequest
...
async def evaluate_alarms_now(_: User = Depends(require_superadmin)) -> dict[str, str]:
